...
// GetTaskHistory retrieves the commit history for a task's file from git.
...
// Returns an empty Entries slice (not an error) when no commits exist for the task file.
